...
public class AuthorController {
    ...
    public List<AuthorResponseDTO> getAll() {
        ...
        List<AuthorResponseDTO> authors = authorRepository.findAll(PageRequest.of(0,20)).stream().filter(author -> uniqueNames.add(author.getName())).map(AuthorResponseDTO::new).toList();
        return authors;
    }
